...
const MainButton = ({children, className}: Props) => {
    return (
        <button className={"group relative flex justify-center items-center bg-white border-[1px] border-darkslategrey-600 rounded-full overflow-hidden " + className }>
            <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-darkslategrey-600 rounded-full w-[96%] h-[90%] transition-all duration-300 group-hover:scale-150">
