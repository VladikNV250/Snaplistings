                            ...
                            {Brands.map((brand, index) => (
                                ...
                                >
                                    <Image
                                        ...
                                        height={brand.height}
                                        quality={100}
                                        className={`xl:h-[70px] lg:h-[55px] h-[30px] w-max `}
                                    />
                                </div>
                            ))}
                        </div>
                        <div className="xl:animate-slide xl:block hidden absolute left-[2536px] top-0 h-28 min-w-full w-[2536px] overflow-x-hidden flex items-center justify-end space-x-18 z-30 pl-12">
                            {Brands.map((brand, index) => (
                                <div 
                                    key={`${index}-second`} 
            ...
            }
            {
                mode === 'snaplistings' ?
                    <div key={id} id={id} className="absolute top-1/4 left-0 w-full h-28">
                        <div className="xl:flex hidden animate-slide-slower-firstly absolute top-0 left-[3366px] h-28 min-w-full w-[3366px] overflow-x-hidden flex items-center space-x-18 z-10 pl-12">
                        ...
                        <div className="xl:flex hidden animate-slide-slower absolute top-0 left-[3366px] h-28 min-w-full w-[3366px] overflow-x-hidden flex items-center space-x-18 z-10 pl-12">
                            {Array.from({ length: 4 }, (_, index): ReactNode => (
                                <>
                                    <div key={index} className={`h-full w-max flex items-center`}>
                                        <Image
