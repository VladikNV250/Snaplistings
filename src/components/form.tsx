...
const Form = () => {
    ...
    return (
        <section className="relative overflow-hidden w-full flex flex-col items-center pt-32 pb-24 bg-neutral-100" id="formSection">
            ...
            <h2 
                className={clsx(
                    "xl:text-5.5xl lg:text-4xl md:text-2xl text-center font-bold",
            ...
            <p className="xl:text-xl lg:text-base md:text-sm text-stone-900 mt-4 z-20">Request a case study in your industry and chat with our team!</p>
            <form id="form" action="" className="xl:w-[840px] lg:w-[800px] md:w-full md:px-2 flex flex-col items-center z-10 mt-18 space-y-6 z-20">
            ...
            <MainButton form="form" type="submit" className="xl:h-14 xl:w-48 md:w-40 md:h-11 bg-white border-darkslategray-600 z-20 mt-20" bgClassName="bg-darkslategray-600">
                <p className="text-white font-medium xl:text-xl md:text-base whitespace-nowrap z-20 cursor-pointer">Get Connected</p>
            </MainButton>
        </section>
    )
}
