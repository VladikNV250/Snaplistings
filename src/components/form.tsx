...
const Form = () => {
    ...
    return (
        <section className="relative overflow-hidden w-full flex flex-col items-center pt-32 pb-24 bg-neutral-100" id="formSection">
            ...
            <h2 
                className={clsx(
                    "text-2xl text-center font-bold gradient-b ",
                    "lg:text-4xl xl:text-5.5xl/tight",
            ...
            <p className="text-sm text-stone-900 mt-4 z-20 lg:text-base xl:text-xl">Request a case study in your industry and chat with our team!</p>
            <form id="form" action="" className="w-full px-2 lg:px-0 flex flex-col items-center z-10 mt-18 space-y-6 z-20 lg:w-[800px] xl:w-[840px]">
                <div className="w-full relative flex flex-col">
                    <h5 className="text-base text-darkslategray-600 font-medium">What is your industry?</h5>
                    <div className="flex flex-wrap justify-between items-center gap-y-4 lg:gap-x-4 lg:flex-nowrap mt-1">
                        <div className="checkbox group w-[calc(50%-0.5rem)] lg:w-50 h-14 flex justify-center items-center space-x-1.5 bg-white border-2 border-darkslategray-600 rounded-full cursor-pointer transition-color duration-300 shadow-xl hover:border-tango-500">
                ...
                <div className="w-full flex flex-col justify-between items-center space-y-6 md:space-y-0 md:space-x-4 md:flex-row">
            ...
            <MainButton form="form" type="submit" className="w-40 h-11 bg-white border-darkslategray-600 z-20 mt-20 xl:h-14 xl:w-48" bgClassName="bg-darkslategray-600">
                <p className="text-white font-medium text-base whitespace-nowrap z-20 cursor-pointer xl:text-xl">Get Connected</p>
            </MainButton>
        </section>
    )
}
