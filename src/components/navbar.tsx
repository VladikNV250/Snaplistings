...
const Navbar = () => {
    ...
    return (
        <>
            ...
            <nav 
                className={clsx(
                    "fixed w-full h-18 lg:px-12 px-3 z-40",
                    "flex justify-between items-center",
                    "backdrop-blur border-darkslategray-500/60",
                    "transition-all duration-500 transform",
                    !visible && 'lg:-translate-y-18',
                    active && !visible && 'lg:-translate-y-18',
                    !active && !visible && '-translate-y-18',
                    active && 'border-0 bg-darkslategray-600',
                    !active && 'border-b-[1px] bg-white/85',
                )}
            >   
                <Link onClick={() => setActive(false)} href={'/'} className="relative xl:h-[32px] xl:w-max lg:h-[26px]">
                    <Image
                ...
                <div className="links hidden lg:flex items-center  absolute left-1/2 transform -translate-x-1/2 h-full space-x-12">
                ...
                <MainButton className="hidden lg:flex w-40 h-11 bg-white border-darkslategray-600" bgClassName="bg-darkslategray-600">
